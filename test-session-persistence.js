...
async function testSessionPersistence() {
  ...
  try {
    ...
    // 4. 发送第二条消息（传递sessionId）
    console.log('4. 发送第二条消息（传递sessionId）...');
    ...
    // 7. 测试会话持久化（模拟页面刷新）
    console.log('\n7. 测试会话持久化...');
    console.log('模拟页面刷新后，sessionId应该保持不变');
    console.log('当前sessionId:', sessionId1);
    console.log('如果前端正确持久化，下次发送消息时应该使用相同的sessionId');
